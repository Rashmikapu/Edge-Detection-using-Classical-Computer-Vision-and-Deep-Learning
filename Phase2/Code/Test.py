...
def TestOperation(ImgPH, ImageSize, ModelPath, DataPath, LabelsPathPred):
    ...
    #_, prSoftMaxS = CIFAR10Resnet(ImgPH, ImageSize, 1)
...
def main():
    ...
    Parser.add_argument('--ModelPath', dest='ModelPath', default='/home/rashmikapu/Downloads/YourDirectoryID_hw0(1)/YourDirectoryID_hw0/Phase2/Checkpoints/4model.ckpt', help='Path to load latest model from, Default:ModelPath')
    Parser.add_argument('--BasePath', dest='BasePath', default='/home/rashmikapu/Downloads/YourDirectoryID_hw0(1)/YourDirectoryID_hw0/Phase2/CIFAR10/Test/', help='Path to load images from, Default:BasePath')
    ...
    ConfusionMatrix(list(LabelsTrue), list(LabelsPred))
